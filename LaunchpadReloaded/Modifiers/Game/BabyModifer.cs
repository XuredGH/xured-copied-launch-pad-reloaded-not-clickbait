...
public sealed class BabyModifier : LPModifier
{
    ...
    public override bool IsModifierValidOn(RoleBehaviour role) => base.IsModifierValidOn(role) && !role.Player.HasModifier<SmolModifier>() && !role.Player.HasModifier<GiantModifier>() && !role.Player.HasModifier<GiantModifier>();
